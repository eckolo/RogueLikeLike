...
namespace Assets.Src.Domains.Models.Value
{
    public partial class Ailment
    {
        ...
        /// </summary>
        [Serializable]
        public class Parameters : IKeyValueLike<Ailment, KeyValuePair<int, int>>
        {
            /// <summary>
            /// コンストラクタ
            /// </summary>
            ...
            public Parameters(Ailment key, int amount, int duration)
            {
                _key = key;
                _amount = amount;
                _duration = duration;
            ...
            /// </summary>
            [SerializeField]
            Ailment _key = default(Ailment);
            /// <summary>
            /// 辞書型変換用プロパティ
            /// </summary>
            public Ailment key => _key;
